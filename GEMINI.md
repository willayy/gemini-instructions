...
- The SRP (Single Responsibility Principle, stating that each software entity should have only one reason to change) should be followed in all scopes, be it functions, classes, files, packages, etc.
